...
namespace QuantLib {
    ...
    Day Calendar::ChineseNewYear(const Year& y){
        static const Day NewYear[] = {
        49, 38, 28, 46, 34, 24, 43, 32, 21,   // 1901-1909
        40, 29, 48, 36, 25, 44, 33, 22, 41, 31,   // 1910-1919
        50, 38, 27, 46, 35, 23, 43, 32, 22, 40,   // 1920-1929
        29, 47, 36, 25, 44, 34, 23, 41, 30, 49,   // 1930-1939
        38, 26, 45, 35, 24, 43, 32, 21, 40, 28,   // 1940-1949
        47, 36, 26, 44, 33, 23, 42, 30, 48, 38,   // 1950-1959
        27, 45, 35, 24, 43, 32, 20, 39, 29, 47,   // 1960-1969
        36, 26, 45, 33, 22, 41, 30, 48, 37, 27,   // 1970-1979
        46, 35, 24, 43, 32, 50, 39, 28, 47, 36,   // 1980-1989
        26, 45, 34, 22, 40, 30, 49, 37, 27, 46,   // 1990-1999
        35, 23, 42, 31, 21, 39, 28, 48, 37, 25,   // 2000-2009
        44, 33, 22, 40, 30, 49, 38, 27, 46, 35,   // 2010-2019
        24, 42, 31, 21, 40, 28, 47, 36, 25, 43,   // 2020-2029
        33, 22, 41, 30, 49, 38, 27, 45, 34, 23,   // 2030-2039
        42, 31, 21, 40, 29, 47, 36, 25, 44, 32,   // 2040-2049
        22, 41, 31, 49, 38, 27, 45, 34, 23, 42,   // 2050-2059
        32, 20, 39, 28, 47, 35, 25, 44, 33, 22,   // 2060-2069
        41, 30, 49, 37, 26, 45, 35, 23, 42, 32,   // 2070-2079
        21, 39, 28, 47, 36, 25, 44, 33, 23, 40,   // 2080-2089
        29, 48, 37, 26, 45, 35, 24, 42, 31, 20,   // 2090-2099
        39, 28, 47, 37, 27, 45, 34, 23, 42, 30,   // 2100-2109
        49, 38, 28, 46, 36, 25, 44, 32, 21, 40,   // 2110-2119
        29, 47, 37, 26, 45, 33, 22, 41, 31, 49,   // 2120-2129
        38, 28, 47, 35, 24, 43, 32, 21, 40, 29,   // 2130-2139
        48, 37, 26, 45, 34, 22, 41, 31, 50, 38,   // 2140-2149
        28, 46, 35, 24, 42, 32, 22, 40, 29, 48,   // 2150-2159
        37, 25, 44, 33, 23, 41, 31, 50, 39, 27,   // 2160-2169
        46, 35, 24, 42, 32, 22, 41, 29, 48, 37,   // 2170-2179
        26, 44, 33, 23, 42, 30, 20, 38, 27, 45,   // 2180-2189
        35, 24, 43, 32, 21, 40, 29, 47, 36, 26    // 2190-2199
    };
    return NewYear[y - 1901];
    }
   ...
   // Western calendars
    ...
    bool Calendar::ChineseImpl::isWeekend(Weekday w) const {
        return w == Saturday || w == Sunday;
    }

    Day Calendar::ChineseImpl::newYear(Year y) {
        static const Day NewYear[] = {
            49, 38, 28, 46, 34, 24, 43, 32, 21,   // 1901-1909
            40, 29, 48, 36, 25, 44, 33, 22, 41, 31,   // 1910-1919
            50, 38, 27, 46, 35, 23, 43, 32, 22, 40,   // 1920-1929
